...
#fun fact, this code was 99% generated by Copilot.
#it saved me literally hours of my life
pgh_1 = [ #PGH list 1 is Matthew - John
...
pgh_2 = [ #PGH list 2 is the Pentatuach
...
pgh_3 = [ #PGH list 3 is Romans - Philemon and then Hebrews
...
pgh_4 = [ #PGH list 4 is the rest of the New Testament
...
pgh_5 = [ #PGH list 5 is Job, Ecclesiastes, and Song of Solomon
...
pgh_8 = [ #PGH list 8 is Joshua - Esther (Historical Books)
...
pgh_9 = [ #PGH list 9 is Isaiah - Malachi (Prophetic Books)
    ...
    "Jeremiah 31", "Jeremiah 32", "Jeremiah 33", "Jeremiah 34",
    "Jeremiah 35", "Jeremiah 36", "Jeremiah 37", "Jeremiah 38",
    "Jeremiah 39", "Jeremiah 40", "Jeremiah 41", "Jeremiah 42",
    "Jeremiah 43", "Jeremiah 44", "Jeremiah 45", "Jeremiah 46",
    "Jeremiah 47", "Jeremiah 48", "Jeremiah 49", "Jeremiah 50",
    "Jeremiah 51", "Jeremiah 52", "Lamentations 1", "Lamentations 2",
    "Lamentations 3", "Lamentations 4", "Lamentations 5", "Ezekiel 1",
    ...
    "Ezekiel 18", "Ezekiel 19", "Ezekiel 20", "Ezekiel 21",
    "Ezekiel 22", "Ezekiel 23", "Ezekiel 24", "Ezekiel 25",
    "Ezekiel 26", "Ezekiel 27", "Ezekiel 28", "Ezekiel 29",
    ...
    "Ezekiel 46", "Ezekiel 47", "Ezekiel 48", "Daniel 1",
    "Daniel 2", "Daniel 3", "Daniel 4", "Daniel 5",
    "Daniel 6", "Daniel 7", "Daniel 8", "Daniel 9",
    "Daniel 10", "Daniel 11", "Daniel 12", "Hosea 1",
    "Hosea 2", "Hosea 3", "Hosea 4", "Hosea 5",
    "Hosea 6", "Hosea 7", "Hosea 8", "Hosea 9",
    "Hosea 10", "Hosea 11", "Hosea 12", "Hosea 13",
    "Hosea 14", "Joel 1", "Joel 2", "Joel 3",
    "Amos 1", "Amos 2", "Amos 3", "Amos 4",
    "Amos 5", "Amos 6", "Amos 7", "Amos 8",
    "Amos 9", "Obadiah 1", "Jonah 1", "Jonah 2",
    "Jonah 3", "Jonah 4", "Micah 1", "Micah 2",
    "Micah 3", "Micah 4", "Micah 5", "Micah 6",
    "Micah 7", "Nahum 1", "Nahum 2", "Nahum 3",
    "Habakkuk 1", "Habakkuk 2", "Habakkuk 3", "Zephaniah 1",
    "Zephaniah 2", "Zephaniah 3", "Haggai 1", "Haggai 2",
    ...
    "Zechariah 13", "Zechariah 14", "Malachi 1", "Malachi 2",
    "Malachi 3", "Malachi 4"
]

pgh_10 = [ #PGH list 10 is Acts
...
def getPsalms(iteration):
    day = datetime.now().day
    if day >= 1 and day <= 30:
        return "Psalms {}".format(day * iteration)
    else:
        return "Day Off"